...
- (UIView *)viewForZoomingInScrollView:(UIScrollView *)scrollView {
    ...
    // Return the view that the user will be zooming
    return self.containerView;
}

- (void)scrollViewDidZoom:(UIScrollView *)scrollView {
    
    // The scroll view has zoomed, so re-center contents
...
- (void)viewDidLoad {
    ...
    UIView *redView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 640.0f, 640.0f)];
    ...
    // Tell the scrollView the size of the contents
